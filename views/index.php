...
<body>
        ...
        <div class="row-items">
            <div class="container-box">
                <div class="container-img">
                    <img src="../../travigo2.0/views/img/trip1.png">
                </div>
                <h4>Ship Cruises</h4>
                <p>150 Properties</p>
            </div>
            ...
            <div class="container-box">
                <div class="container-img">
                    <img src="../../travigo2.0/views/img/trip2.png">
                </div>
                <h4>Food Tours</h4>
                <p>150 Properties</p>
            </div>
            ...
            <div class="container-box">
                <div class="container-img">
                    <img src="../../travigo2.0/views/img/trip3.png">
                </div>
                <h4>Summer Rest</h4>
                <p>150 Properties</p>
            </div>
    ...
    <section class="destination" id="destination">
        ...
        <div class="destination-content">
            ...
            <div class="col-content">
                <img src="../../travigo2.0/views/img/img-4.jpg">
                <h5>Machu Picchu</h5>
                <p>PERU</p>
            </div>

            <div class="col-content">
                <img src="../../travigo2.0/views/img/img-5.jpg">
                <h5>Machu Picchu</h5>
                <p>PERU</p>
            </div>

            <div class="col-content">
                <img src="../../travigo2.0/views/img/img-6.jpg">
                <h5>Machu Picchu</h5>
                <p>PERU</p>
            </div>
